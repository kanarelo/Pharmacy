...
$(function() {
    ...
    if (titleBG != null) {
        $("#pattern").css("backgroundImage", "url(../images/" + titleBG + ")");
    }

    if (bodyBG != null) {
        $("body").css("backgroundImage", "url(../images/" + bodyBG + ")");
    }
...
function changeTitlePattern() {
    ...
    //alert("url(../images/"+imgfile+")");
    $("#pattern").css("backgroundImage", "url(../images/" + imgfile + ")");
...
function changeBGPattern() {
    ...
    //alert("url(../images/"+imgfile+")");
    $("body").css("backgroundImage", "url(../images/" + imgfile + ")");
...
function changePreset(){
    ...
    $("#pattern").css("backgroundImage", "url(../images/" + presets[3] + ")");
    createCookie('titleBG', presets[3] );
    $("body").css("backgroundImage", "url(../images/" + presets[4] + ")");
