<?php
	...
	$nurse_edit = new Route("$BASE_URL/admin/staff/nurses/:id/edit/");
	$nurse_edit->setMapClass("Nurse")->setMapMethod("edit")
				   ->addDynamicElement( ":id", '^\d+$' );
	$router->addRoute("nurse-edit",$nurse_edit);
	
	$nurse_delete = new Route("$BASE_URL/admin/staff/nurses/:id/delete/");
	...
	$router->addRoute( "nurses-my-order-list", $nurse_order_list );
