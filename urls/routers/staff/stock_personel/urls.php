<?php
	...
	$stock_personel_edit = new Route("$BASE_URL/admin/staff/stock-personel/:id/edit/");
	$stock_personel_edit->setMapClass("StockPersonel")->setMapMethod("edit")
				   ->addDynamicElement( ":id", '^\d+$' );
	$router->addRoute("stock-personel-edit",$stock_personel_edit);
	
	$stock_personel_delete = new Route("$BASE_URL/admin/staff/stock-personel/:id/delete/");
